...
all_test_cases = requests.get(f"{base_url}/projects/{project_id}/test-cases?starting_row={1}&number_of_rows={999}&sort_field={"TestCaseId"}&sort_direction={"ASC"}&release_id={"452"}", headers=headers)
